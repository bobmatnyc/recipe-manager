#!/usr/bin/env python3
"""
Test script for recipe-scrapers with Food & Wine recipes
Tests extraction of 3 sample recipes to verify functionality
"""
...
# Test recipes from Food & Wine
TEST_RECIPES = [
    {
        "url": "https://www.foodandwine.com/recipes/roasted-chicken-thighs",
        "name": "Roasted Chicken Thighs",
    },
    {
        "url": "https://www.foodandwine.com/recipes/classic-chocolate-chip-cookies",
...
def main():
    ...
    print("\n" + "="*70)
    print("TESTING RECIPE-SCRAPERS WITH FOOD & WINE")
    print("="*70)
    ...
    if successful == len(TEST_RECIPES):
        print("\n🎉 All tests passed! recipe-scrapers works perfectly with Food & Wine.")
        print("\nNext steps:")
        print("  1. Extract Nancy Silverton recipe URLs from chef page")
