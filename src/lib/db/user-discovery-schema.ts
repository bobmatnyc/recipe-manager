import { pgTable, text, integer, timestamp, boolean, uuid, varchar, json, decimal, unique, index } from 'drizzle-orm/pg-core';
...
export const insertCollectionRecipeSchema = createInsertSchema(collectionRecipes, {
  personal_note: z.string()
    .max(500, 'Personal note must be at most 500 characters')
    .optional(),
  position: z.number()
    .int()
    .min(0)
