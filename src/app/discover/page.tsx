                  ...
                  <div className="grid grid-cols-2 md:grid-cols-5 gap-2">
                    {generatedRecipe.nutritionInfo.calories && (
                      <div className="text-center p-2 bg-secondary/50 rounded">
                        <div className="text-sm font-medium">{generatedRecipe.nutritionInfo.calories}</div>
                        <div className="text-xs text-muted-foreground">Calories</div>
                      </div>
                    )}
                    {generatedRecipe.nutritionInfo.protein && (
                      <div className="text-center p-2 bg-secondary/50 rounded">
                        <div className="text-sm font-medium">{generatedRecipe.nutritionInfo.protein}g</div>
                        <div className="text-xs text-muted-foreground">Protein</div>
                      </div>
                    )}
                    {generatedRecipe.nutritionInfo.carbs && (
                      <div className="text-center p-2 bg-secondary/50 rounded">
                        <div className="text-sm font-medium">{generatedRecipe.nutritionInfo.carbs}g</div>
                        <div className="text-xs text-muted-foreground">Carbs</div>
                      </div>
                    )}
                    {generatedRecipe.nutritionInfo.fat && (
                      <div className="text-center p-2 bg-secondary/50 rounded">
                        <div className="text-sm font-medium">{generatedRecipe.nutritionInfo.fat}g</div>
                        <div className="text-xs text-muted-foreground">Fat</div>
                      </div>
                    )}
                    {generatedRecipe.nutritionInfo.fiber && (
                      <div className="text-center p-2 bg-secondary/50 rounded">
                        <div className="text-sm font-medium">{generatedRecipe.nutritionInfo.fiber}g</div>
